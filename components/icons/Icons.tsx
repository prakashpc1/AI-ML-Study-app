...
export const AcademyLogoIcon: React.FC<IconProps> = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 3L1 9L12 15L23 9L12 3Z" />
    <path d="M5 12.5V17C5 17 8.5 19 12 19C15.5 19 19 17 19 17V12.5L12 16L5 12.5Z" />
  </svg>
);
...
export const BrainCircuit: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 5a3 3 0 1 0-5.993.142"></path><path d="M18 5a3 3 0 1 0-5.993.142"></path><path d="M12 19a3 3 0 1 0-5.993-.142"></path><path d="M18 19a3 3 0 1 0-5.993-.142"></path><path d="M12 12a3 3 0 1 0-5.993.142"></path><path d="M18 12a3 3 0 1 0-5.993.142"></path><path d="M21 12h-1"></path><path d="M4 12H3"></path><path d="M21 5h-1"></path><path d="M4 5H3"></path><path d="M21 19h-1"></path><path d="M4 19H3"></path><path d="m13.3 5.3 1.4-1.4"></path><path d="m4.3 14.7 1.4-1.4"></path><path d="m13.3 18.7 1.4 1.4"></path><path d="m4.3 9.7 1.4 1.4"></path><path d="m18.7 5.3-1.4-1.4"></path><path d="m9.3 14.7-1.4-1.4"></path><path d="m18.7 18.7-1.4 1.4"></path><path d="m9.3 9.7-1.4 1.4"></path>
    </svg>
);
...
export const ChartLineUp: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <line x1="4" y1="19" x2="20" y2="19"></line><polyline points="4 15 8 9 12 11 16 6 20 10"></polyline>
  </svg>
);
...
export const CloudDrought: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M17.5 22h.5a5 5 0 0 0 1.7-9.7A6.5 6.5 0 0 0 7.3 6.9 5 5 0 0 0 6 17"></path><path d="M12 12v4"></path><path d="M12 22h.01"></path><path d="M16 16.01h.01"></path><path d="M8 16.01h.01"></path><path d="M10 19h4"></path>
    </svg>
);
...
export const Shapes: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M8.3 10a.7.7 0 0 1-.626-1.079L11.4 3a.7.7 0 0 1 1.252 0l3.725 5.921A.7.7 0 0 1 15.7 10Z"></path><rect x="3" y="14" width="7" height="7" rx="1"></rect><circle cx="17.5" cy="17.5" r="3.5"></circle>
    </svg>
);
...
export const Library: React.FC<IconProps> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const Sparkles: React.FC<IconProps> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m12 3-1.9 4.8-4.8 1.9 4.8 1.9L12 21l1.9-4.8 4.8-1.9-4.8-1.9L12 3z"></path><path d="M5 3v4"></path><path d="M19 17v4"></path><path d="M3 5h4"></path><path d="M17 19h4"></path>
  </svg>
);
